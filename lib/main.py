...
def run(playwright: Playwright):
    ...
    # 查看BitBrowser主进程是否存在
    def is_bitbrowser_running():
        for proc in psutil.process_iter(['name']):
            try:
                if proc.info['name'] and 'BitBrowser' in proc.info['name']:
                    return True
    ...
    while 1:
        # 启动浏览器
        browser_id = "2132a8374ed54dfa907647117e5cbab5"
        ...
        page.goto('https://bigmodel.cn/login?redirect=%2Fusercenter%2Fsettings%2Faccount')
